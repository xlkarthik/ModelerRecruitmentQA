...
import type { DifficultyLevel, WorktestSpecs } from "@/lib/worktestConfig";

export interface WorktestQAProps {
  worktestConfig: Record<DifficultyLevel, WorktestSpecs>;
  referenceImages: Record<DifficultyLevel, string[]>;
  variantTitle: string;
  meshNaming?: readonly string[];
}

export default function WorktestQA({
  worktestConfig: WORKTEST_CONFIG,
    ...
    <div className="max-w-4xl mx-auto p-6 bg-gray-50">
      {loadingQA ? (
          ...
          <div className="mb-8 bg-white p-6 rounded-lg shadow-sm">
            ...
            <div className="bg-blue-50 p-4 rounded-lg">
              <div className="text-sm text-blue-800 space-y-1">
                ...
                {meshNaming && meshNaming.length > 0 && (
                  <p>
                    <strong>Mesh names:</strong>{" "}
        ...
        <>
          ...
          <h1 className="text-2xl font-bold mb-6">{variantTitle} Worktest QA Tool</h1>
